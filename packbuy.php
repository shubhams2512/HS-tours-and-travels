...
{
    $packid=$_GET['packid'];
    header("location:buy.php?packid=$packid&category=internationalpackage");
}
 else if (!isset($_SESSION['email']) and isset ($_GET['bookbtn'])){
    $packid=$_GET['packid'];
    header("location:packbuy.php?packid=$packid&msg=please login first to buy");    
}


$packid=$_GET['packid'];
$con= mysqli_connect('localhost','root','','hstoursandtravels');
         $q="select * from internationalpackage where packid='$packid'";
     ...
     <?php include("header.php"); ?>
       <div class="row" style="margin-bottom: 30px">
           <div class="col-sm-6" >
               ...
               ?>
               <img src='./IMAGES/INTERNATIONAL/<?php echo "$packid"; ?>.jpg' class='img-responsive img-thumbnail'>
       ...
       <div class="row">
           ...
           <div class="col-sm-8" style="padding-left: 50px">
               <a href="favourite.php?packid=<?php echo "$packid";?>&category=internationalpackage" class=" btn btn-primary">
                   <?php 
                     if(isset($_GET['msg3']))
                     {
                        echo "$_GET[msg3]";                         
