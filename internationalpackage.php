...
<body>
   <div class="container-fluid" style="background-color:#B4A1BD">
     ...
     <?php 
         ...
         $q="select * from internationalpackage";
         ...
         for($i=0;$i<$num;$i++)
         {
             ...
             ?>
       <a href=packbuy.php?packid=<?php echo"$rowarr[packid]"; ?> >
           <div class="row">
           <div class="col-sm-4">
               <img src="./IMAGES/INTERNATIONAL/<?php echo "$rowarr[packid]"; ?>.jpg" alt='image' class="img-responsive img-thumbnail"/>
               <br>
               <br>
           </div>
